...
wget -c https://striim-downloads.s3.us-west-1.amazonaws.com/Releases/4.2.0.1/striim-node-4.2.0.1-Linux.deb
wget -c https://striim-downloads.s3.us-west-1.amazonaws.com/Releases/4.2.0.1/striim-dbms-4.2.0.1-Linux.deb

# Run installs for Ubuntu
sudo dpkg -i striim-node-4.2.0.1-Linux.deb
sudo dpkg -i striim-dbms-4.2.0.1-Linux.deb
